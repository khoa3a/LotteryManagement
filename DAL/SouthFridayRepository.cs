...
namespace DAL
{
    public class SouthFridayRepository : BaseRepository<SouthFridayEntity, SouthFridaySearchCriteria, SouthFridaySearchResult, LotteryManagementEntities>
    {
        protected override IQueryable<SouthFridayEntity> BuildQuery(SouthFridaySearchCriteria criteria)
        {
            _baseQuery = _dbContext.Set<SouthFridayEntity>().AsNoTracking();
        ...
        protected override IQueryable<SouthFridayEntity> BuildSort(IQueryable<SouthFridayEntity> query, SouthFridaySearchCriteria criteria)
        {
