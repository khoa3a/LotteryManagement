...
namespace DAL
{
    public abstract class BaseRepository<TEntity, TSearchCriteria, TSearchResult, TContext> : IRepository<TEntity, TSearchCriteria, TSearchResult, TContext>, IDisposable
        where TEntity : class
