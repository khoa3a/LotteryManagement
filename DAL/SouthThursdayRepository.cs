...
namespace DAL
{
    public class SouthThursdayRepository : BaseRepository<SouthThursdayEntity, SouthThursdaySearchCriteria, SouthThursdaySearchResult, LotteryManagementEntities>
    {
        protected override IQueryable<SouthThursdayEntity> BuildQuery(SouthThursdaySearchCriteria criteria)
        {
        ...
        protected override IQueryable<SouthThursdayEntity> BuildSort(IQueryable<SouthThursdayEntity> query, SouthThursdaySearchCriteria criteria)
        {
