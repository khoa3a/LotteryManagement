...
namespace DAL
{
    public class NorthWednesdayRepository : BaseRepository<NorthWednesdayEntity, NorthWednesdaySearchCriteria, NorthWednesdaySearchResult, LotteryManagementEntities>
    {
        protected override IQueryable<NorthWednesdayEntity> BuildQuery(NorthWednesdaySearchCriteria criteria)
        {
            _baseQuery = _dbContext.Set<NorthWednesdayEntity>().AsNoTracking();
        ...
        protected override IQueryable<NorthWednesdayEntity> BuildSort(IQueryable<NorthWednesdayEntity> query, NorthWednesdaySearchCriteria criteria)
        {
