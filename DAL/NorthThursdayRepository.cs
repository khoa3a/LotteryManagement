...
namespace DAL
{    
    public class NorthThursdayRepository : BaseRepository<NorthThursdayEntity, NorthThursdaySearchCriteria, NorthThursdaySearchResult, LotteryManagementEntities>
    {
        protected override IQueryable<NorthThursdayEntity> BuildQuery(NorthThursdaySearchCriteria criteria)
        {
            _baseQuery = _dbContext.Set<NorthThursdayEntity>().AsNoTracking();
        ...
        protected override IQueryable<NorthThursdayEntity> BuildSort(IQueryable<NorthThursdayEntity> query, NorthThursdaySearchCriteria criteria)
        {
